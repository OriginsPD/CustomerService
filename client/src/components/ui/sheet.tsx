...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-vcc-navy border-white/10 shadow-2xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-2 text-left px-6 pt-6", className)}
    {...props}
  />
);
